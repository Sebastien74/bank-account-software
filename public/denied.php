                ...
                <div class="col-12 my-auto">
                    ...
                    <h2 class="w-100 text-center">
                        <?php if (!empty($_GET['site'])) : ?>
                            <p>You are not allowed to access !! <br/> <strong>Ask to webmaster</strong></p>
                        <?php else : ?>
                            <p>Sorry, your access is refused due to security reasons of our server and also our sensitive data. Please go back to the previous page to continue browsing.</p>
                        <?php endif; ?>
                    </h2>
                </div>
            </div>
