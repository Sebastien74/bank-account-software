    ...
    function post(form) {
        ...
        xHttp.onload = function (e) {
            if (this.readyState === 4 && this.status === 200) {
                ...
                let domSelects = document.querySelectorAll('select, input');
                ...
                for (let i = 0; i < domSelects.length; i++) {
                    let domSelect = domSelects[i];
                    isSelected(domSelect);
                    domSelect.addEventListener('change', (e) => {
                        let formPost = domSelect.closest('form');
                        post(formPost);
                    })
                }
