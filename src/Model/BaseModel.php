...
class BaseModel extends FunctionModel
{
     ...
     * To set CoreLocator.
     */
    protected static function setLocators(CoreLocatorInterface $coreLocator): void
    {
    ...
    protected static function getContent(
        ...
        if (is_object($entity)) {
            ...
            if ($contentToCheck && is_object($contentToCheck) || $contentToCheck && is_array($contentToCheck)) {
    ...
    {
        if (!empty($cache[get_class($entity)][$property][$entity->getId()])) {
