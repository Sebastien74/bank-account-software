...
class SeoConfiguration extends BaseInterface
{
    ...
    #[ORM\OneToOne(mappedBy: 'seoConfiguration', targetEntity: Website::class)]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Website $website = null;

    #[ORM\OneToMany(mappedBy: 'seoConfiguration', targetEntity: SeoConfigurationIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
