...
class Zone extends BaseConfiguration
{
    ...
    #[ORM\OneToMany(mappedBy: 'zone', targetEntity: ZoneIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $intls;

    #[ORM\OneToMany(mappedBy: 'zone', targetEntity: ZoneMediaRelation::class, cascade: ['persist'], orphanRemoval: true)]
    ...
    #[ORM\OneToMany(mappedBy: 'zone', targetEntity: Col::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
