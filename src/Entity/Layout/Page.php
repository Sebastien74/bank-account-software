...
class Page extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'page', targetEntity: PageMediaRelation::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'page', targetEntity: PageIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
