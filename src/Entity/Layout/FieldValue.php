...
class FieldValue extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'fieldValue', targetEntity: FieldValueIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $intls;

    #[ORM\OneToMany(mappedBy: 'value', targetEntity: FieldValue::class)]
