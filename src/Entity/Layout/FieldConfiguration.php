...
class FieldConfiguration
{
    ...
    #[ORM\OneToOne(mappedBy: 'fieldConfiguration', targetEntity: Block::class, cascade: ['persist', 'remove'])]
    private ?Block $block = null;

    #[ORM\OneToMany(mappedBy: 'configuration', targetEntity: FieldValue::class, cascade: ['persist'], orphanRemoval: true)]
