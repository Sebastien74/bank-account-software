...
class Profile extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'profile', targetEntity: UserFront::class, cascade: ['persist', 'remove'])]
    private ?UserFront $userFront = null;

    #[ORM\OneToMany(mappedBy: 'profile', targetEntity: Link::class, cascade: ['persist', 'remove'])]
