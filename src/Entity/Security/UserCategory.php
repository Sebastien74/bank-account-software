...
class UserCategory extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'category', targetEntity: UserFront::class, cascade: ['persist'], orphanRemoval: true)]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $userFronts;

    #[ORM\OneToMany(mappedBy: 'category', targetEntity: UserCategoryIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
