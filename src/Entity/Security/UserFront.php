...
class UserFront extends BaseSecurity
{
    ...
    #[ORM\OneToOne(inversedBy: 'userFront', targetEntity: Picture::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(nullable: true, onDelete: 'cascade')]
    private ?Picture $picture = null;

    #[ORM\OneToOne(inversedBy: 'userFront', targetEntity: Profile::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(nullable: true, onDelete: 'cascade')]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Profile $profile = null;

    #[ORM\OneToOne(inversedBy: 'userFront', targetEntity: UserRequest::class, cascade: ['persist', 'remove'])]
