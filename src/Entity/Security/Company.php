...
class Company extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'company', targetEntity: Logo::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Logo $logo = null;

    #[ORM\OneToOne(mappedBy: 'company', targetEntity: CompanyAddress::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
