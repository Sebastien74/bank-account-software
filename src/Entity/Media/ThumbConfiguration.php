...
class ThumbConfiguration extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'configuration', targetEntity: ThumbAction::class, cascade: ['persist'])]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $actions;

    #[ORM\OneToMany(mappedBy: 'configuration', targetEntity: Thumb::class, cascade: ['persist'])]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[Assert\Valid(['groups' => ['form_submission']])]
