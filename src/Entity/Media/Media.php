...
class Media extends BaseInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'media', targetEntity: Thumb::class, cascade: ['persist'], fetch: 'EAGER')]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $thumbs;

    #[ORM\OneToMany(mappedBy: 'media', targetEntity: Media::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['id' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaScreens;

    #[ORM\OneToMany(mappedBy: 'media', targetEntity: MediaIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
