...
class Module extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'module', targetEntity: Action::class, cascade: ['persist'])]
    private ArrayCollection|PersistentCollection $actions;

    #[ORM\OneToMany(mappedBy: 'module', targetEntity: ModuleIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
