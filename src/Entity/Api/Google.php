...
class Google
{
    ...
    #[ORM\OneToOne(mappedBy: 'google', targetEntity: Api::class, cascade: ['persist', 'remove'])]
    private ?Api $api = null;

    #[ORM\OneToMany(mappedBy: 'google', targetEntity: GoogleIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
