...
class Custom
{
    ...
    #[ORM\OneToOne(mappedBy: 'custom', targetEntity: Api::class, cascade: ['persist', 'remove'])]
    private ?Api $api = null;

    #[ORM\OneToMany(mappedBy: 'custom', targetEntity: CustomIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
