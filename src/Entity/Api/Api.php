...
class Api
{
    ...
    #[ORM\OneToOne(inversedBy: 'api', targetEntity: Facebook::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Facebook $facebook = null;

    #[ORM\OneToOne(inversedBy: 'api', targetEntity: Google::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Google $google = null;

    #[ORM\OneToOne(inversedBy: 'api', targetEntity: Instagram::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Instagram $instagram = null;

    #[ORM\OneToOne(inversedBy: 'api', targetEntity: Custom::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Custom $custom = null;

    #[ORM\OneToOne(mappedBy: 'api', targetEntity: Website::class)]
