...
class Facebook
{
    ...
    #[ORM\OneToOne(mappedBy: 'facebook', targetEntity: Api::class, cascade: ['persist', 'remove'])]
    private ?Api $api = null;

    #[ORM\OneToMany(mappedBy: 'facebook', targetEntity: FacebookIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
