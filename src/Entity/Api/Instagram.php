...
class Instagram
{
    ...
    #[ORM\OneToOne(mappedBy: 'instagram', targetEntity: Api::class, cascade: ['persist', 'remove'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Api $api = null;

    #[ORM\OneToMany(mappedBy: 'instagram', targetEntity: InstagramIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
