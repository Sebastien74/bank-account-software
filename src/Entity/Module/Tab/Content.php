...
class Content extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'parent', targetEntity: Content::class)]
    private ArrayCollection|PersistentCollection $contents;

    #[ORM\OneToMany(mappedBy: 'content', targetEntity: ContentMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'content', targetEntity: ContentIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
