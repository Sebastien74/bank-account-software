...
class Link extends BaseEntity
{
    ...
    #[ORM\OneToOne(inversedBy: 'link', targetEntity: LinkIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER')]
    #[ORM\JoinColumn(name: 'intl_id', referencedColumnName: 'id', onDelete: 'cascade')]
    private ?LinkIntl $intl = null;

    #[ORM\OneToOne(inversedBy: 'link', targetEntity: LinkMediaRelation::class, cascade: ['persist', 'remove'], fetch: 'EXTRA_LAZY')]
    ...
    #[ORM\OneToMany(mappedBy: 'parent', targetEntity: Link::class)]
