...
class Agenda extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'agenda', targetEntity: Period::class, orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['publicationStart' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $periods;

    #[ORM\OneToMany(mappedBy: 'agenda', targetEntity: AgendaMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'agenda', targetEntity: AgendaIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
