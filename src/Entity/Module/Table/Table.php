...
class Table extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'table', targetEntity: Col::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $cols;

    #[ORM\OneToMany(mappedBy: 'table', targetEntity: TableIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
