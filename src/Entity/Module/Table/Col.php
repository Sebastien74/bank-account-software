...
class Col extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'col', targetEntity: Cell::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $cells;

    #[ORM\OneToMany(mappedBy: 'col', targetEntity: ColIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
