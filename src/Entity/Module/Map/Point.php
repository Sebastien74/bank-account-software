...
class Point extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'point', targetEntity: PointGeoJson::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(name: 'geo_json_id', referencedColumnName: 'id', onDelete: 'SET NULL')]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?PointGeoJson $geoJson = null;

    #[ORM\OneToMany(mappedBy: 'point', targetEntity: PointMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'point', targetEntity: PointIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
