...
class Catalog extends BaseEntity
{
    ...
    protected array $tabs = ['intls', 'features', 'configuration', 'products', 'seo', 'medias'];

    #[ORM\OneToOne(targetEntity: Layout::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(name: 'layout_id', referencedColumnName: 'id')]
    private ?Layout $layout = null;

    #[ORM\OneToMany(mappedBy: 'catalog', targetEntity: Product::class, cascade: ['persist'])]
    #[ORM\OrderBy(['adminName' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $products;

    #[ORM\OneToMany(mappedBy: 'catalog', targetEntity: CatalogMediaRelation::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'catalog', targetEntity: CatalogIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
