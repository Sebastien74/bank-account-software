...
class FeatureValue extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'featureValue', targetEntity: FeatureValueMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'featureValue', targetEntity: FeatureValueIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
