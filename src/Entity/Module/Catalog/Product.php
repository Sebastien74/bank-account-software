...
class Product extends BaseEntity
{
    ...
    #[ORM\OneToOne(inversedBy: 'product', targetEntity: ProductInformation::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(name: 'information_id', referencedColumnName: 'id', nullable: true)]
    private ?ProductInformation $information = null;

    #[ORM\OneToMany(mappedBy: 'product', targetEntity: FeatureValueProduct::class, cascade: ['persist', 'remove'])]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $values;

    #[ORM\OneToMany(mappedBy: 'product', targetEntity: Lot::class, cascade: ['persist', 'remove'])]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $lots;

    #[ORM\OneToMany(mappedBy: 'product', targetEntity: ProductMediaRelation::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'product', targetEntity: ProductIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
