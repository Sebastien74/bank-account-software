...
class Lot extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'lot', targetEntity: LotMediaRelation::class, cascade: ['persist'], orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'lot', targetEntity: LotIntl::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
