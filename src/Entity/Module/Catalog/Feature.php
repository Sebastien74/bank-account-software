...
class Feature extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'catalogfeature', targetEntity: FeatureValue::class, cascade: ['persist', 'remove'])]
    #[ORM\OrderBy(['adminName' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $values;

    #[ORM\OneToMany(mappedBy: 'feature', targetEntity: FeatureMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'feature', targetEntity: FeatureIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
