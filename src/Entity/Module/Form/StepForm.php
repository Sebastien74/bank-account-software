...
class StepForm extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'stepform', targetEntity: Configuration::class, cascade: ['persist', 'remove'])]
    private ?Configuration $configuration = null;

    #[ORM\OneToMany(mappedBy: 'stepform', targetEntity: Form::class, orphanRemoval: true)]
    #[ORM\OrderBy(['position' => 'ASC'])]
    private ArrayCollection|PersistentCollection $forms;

    #[ORM\OneToMany(mappedBy: 'stepform', targetEntity: ContactStepForm::class, cascade: ['persist'], orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $contacts;

    #[ORM\OneToMany(mappedBy: 'stepForm', targetEntity: StepFormIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
