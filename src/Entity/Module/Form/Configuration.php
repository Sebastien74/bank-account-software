...
class Configuration
{
    ...
    #[ORM\OneToOne(inversedBy: 'configuration', targetEntity: Form::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    private ?Form $form = null;

    #[ORM\OneToOne(inversedBy: 'configuration', targetEntity: StepForm::class, cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(onDelete: 'cascade')]
