...
class ContactForm extends BaseInterface
{
    ...
    #[ORM\OneToOne(mappedBy: 'contactForm', targetEntity: CalendarAppointment::class, cascade: ['persist', 'remove'])]
    private ?CalendarAppointment $appointment = null;

    #[ORM\OneToMany(mappedBy: 'contactForm', targetEntity: ContactValue::class, cascade: ['persist'], orphanRemoval: true)]
