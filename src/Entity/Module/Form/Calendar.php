...
class Calendar extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'formcalendar', targetEntity: CalendarAppointment::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $appointments;

    #[ORM\OneToMany(mappedBy: 'formcalendar', targetEntity: CalendarSchedule::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $schedules;

    #[ORM\OneToMany(mappedBy: 'formcalendar', targetEntity: CalendarException::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $exceptions;

    #[ORM\OneToMany(mappedBy: 'calendar', targetEntity: CalendarIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
