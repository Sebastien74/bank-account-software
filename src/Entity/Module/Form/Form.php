...
class Form extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'form', targetEntity: Configuration::class, cascade: ['persist', 'remove'])]
    ...
    #[ORM\OneToMany(mappedBy: 'form', targetEntity: ContactForm::class, cascade: ['persist'], orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $contacts;

    #[ORM\OneToMany(mappedBy: 'form', targetEntity: Calendar::class, cascade: ['persist'], orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $calendars;

    #[ORM\OneToMany(mappedBy: 'form', targetEntity: FormIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
