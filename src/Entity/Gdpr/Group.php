...
class Group extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'gdprgroup', targetEntity: Cookie::class, cascade: ['persist'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $gdprcookies;

    #[ORM\OneToMany(mappedBy: 'group', targetEntity: GroupMediaRelation::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\JoinColumn(onDelete: 'cascade')]
    #[ORM\OrderBy(['position' => 'ASC', 'locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $mediaRelations;

    #[ORM\OneToMany(mappedBy: 'group', targetEntity: GroupIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
