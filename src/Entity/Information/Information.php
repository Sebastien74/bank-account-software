...
class Information extends BaseEntity
{
    ...
    #[ORM\OneToOne(mappedBy: 'information', targetEntity: Website::class)]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ?Website $website = null;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: SocialNetwork::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\OrderBy(['locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $socialNetworks;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: Phone::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\OrderBy(['position' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
    private ArrayCollection|PersistentCollection $phones;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: Email::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\OrderBy(['position' => 'ASC'])]
    private ArrayCollection|PersistentCollection $emails;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: Legal::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $legals;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: ScheduleDay::class, cascade: ['persist'], fetch: 'EAGER', orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $scheduleDays;

    #[ORM\OneToMany(mappedBy: 'information', targetEntity: InformationIntl::class, cascade: ['persist', 'remove'], fetch: 'EAGER', orphanRemoval: true)]
    #[ORM\OrderBy(['locale' => 'ASC'])]
    #[Assert\Valid(['groups' => ['form_submission']])]
