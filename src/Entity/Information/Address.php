...
class Address extends BaseEntity
{
    ...
    #[ORM\OneToMany(mappedBy: 'address', targetEntity: Phone::class, cascade: ['persist'], orphanRemoval: true)]
    private ArrayCollection|PersistentCollection $phones;

    #[ORM\OneToMany(mappedBy: 'address', targetEntity: Email::class, cascade: ['persist'], orphanRemoval: true)]
