...
class CryptController extends AbstractController
{
    ...
    public function encrypt(CryptServiceInterface $cryptService, ?string $string = null): JsonResponse
    {
    ...
    public function decrypt(CryptServiceInterface $codeService, ?string $string = null): JsonResponse
    {
