...
use App\Service\BrowserDetectionInterface;
...
class BrowserRuntime implements RuntimeExtensionInterface
{
    ...
    public function __construct(
        private readonly BrowserDetectionInterface $browserDetection,
    ...
    public function screen(): ?string
    {
        ...
        if ($request instanceof Request && $request->request->get('thumbScreen')) {
            return $request->request->get('thumbScreen');
        }
